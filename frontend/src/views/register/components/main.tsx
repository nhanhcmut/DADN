...
import RegisterRightContent from "./right";
import RegisterLeftContent from "./left";
...
const RegisterMain = () => {
    ...
    return (
        <>
            ...
            <RegisterLeftContent isAnimated={isAnimated} />
            <RegisterRightContent isAnimated={isAnimated} />
        </>
    );
}
