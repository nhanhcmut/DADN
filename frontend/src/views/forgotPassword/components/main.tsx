...
import ForgotPasswordRightContent from "./right";
import ForgotPasswordLeftContent from "./left";
...
const ForgotPasswordMain = () => {
    ...
    return (
        <>
            ...
            <ForgotPasswordLeftContent isAnimated={isAnimated} />
            <ForgotPasswordRightContent isAnimated={isAnimated} />
        </>
    );
}
