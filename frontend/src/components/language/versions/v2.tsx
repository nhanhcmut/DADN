...
const LanguageSwitcherV2 = ({ handleSwitchLanguage }: LanguageVersionProps) => {
        ...
        <Dropdown
            ...
            button={
                <button onClick={handleClick} className="uppercase h-12 w-12 flex justify-center place-items-center font-bold pt-[1px]">
                    <BsGlobe className="h-4 w-4 text-white" />
                </button>
            }
            className={"py-2 top-8"}
        >
            <Container className="!absolute !-right-[38px] bottom-0 flex min-w-32 w-32 !z-50 flex-col justify-start border dark:border-white/10 !rounded-md dark:text-white dark:shadow-none">
